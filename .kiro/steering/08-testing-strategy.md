...
description: Unit testing strategy: fakes over mocks, state-based assertions, 70 percent coverage target. Use when writing or reviewing ViewModel/UseCase tests.
---
