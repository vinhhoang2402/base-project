...
inclusion: auto
name: feature-build
description: Building an individual Gradle feature module fast during local development instead of a full assemble. Use when iterating on a single feature module.
---
