...
description: Structured concurrency, coroutines, and StateFlow patterns (viewModelScope, stateIn, error handling). Use when writing or reviewing suspend functions, Flows, or coroutine scopes.
---
