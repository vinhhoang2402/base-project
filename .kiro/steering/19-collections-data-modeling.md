---
inclusion: auto
name: collections-data-modeling
description: How to pick the right Kotlin collection (List/Set/Map/ArrayDeque), avoid nested Map used only as a membership check (use Set of a small data class instead), and when to use Sequence over List for chained operations. Use when writing or reviewing code that stores/looks up collections of data.
---
