...
import com.demo.projectbase.core.ui.ext.viewBinding
...
class MovieAdapter : BasePagingListAdapter<Movie>(DIFF_CALLBACK) {
    override fun onCreateViewHolder(
        ...
        val binding = parent.viewBinding(ItemMovieBinding::inflate)
        return MovieViewHolder(binding)
    }

    private inner class MovieViewHolder(private val binding: ItemMovieBinding) : BaseViewHolder<Movie>(binding) {
        override fun bind(
            item: Movie,
            position: Int,
        ) {
